	...
	<section class="cover">
		<div class="inner-cover">
			...
			<section class="form-cover">
				<p class="al">Faculty Administrator's Login</p>
...
<?php
	...
	if(isset($_POST['submit'])){
		$resourceClass->login($_POST['username'], $_POST['password'], "Faculty");
	}
?>
				</p>
				...
				<p class="loglink"><a href="https://localhost/scheduler/login">Login as Departmental Administrator</a></p>
			</section>
		</div>
	</section>
</body>
